    ...
    <div class="wrapper">
      ...
      <div class="products">
        <div class="product-card">
          <img src="<?php echo get_template_directory_uri(); ?>/images/section1-1.png" alt="商品名" decoding="async" />
        ...
        <div class="product-card">
          <img src="<?php echo get_template_directory_uri(); ?>/images/section1-2.png" alt="商品名" decoding="async" />
          <div class="product-info">
            <div class="product-info-top">
              <p class="price">$40</p>
              <button class="icon">i</button>
        ...
        <div class="product-card">
          <img src="<?php echo get_template_directory_uri(); ?>/images/section1-3.png" alt="商品名" decoding="async" />
          <div class="product-info">
            <div class="product-info-top">
              <p class="price">$40</p>
              <button class="icon">i</button>
        ...
        <div class="product-card">
          <img src="<?php echo get_template_directory_uri(); ?>/images/section1-4.png" alt="商品名" decoding="async" />
          <div class="product-info">
            <div class="product-info-top">
              <p class="price">$40</p>
              <button class="icon">i</button>
        ...
        <div class="product-card">
          <img src="<?php echo get_template_directory_uri(); ?>/images/section1-5.png" alt="商品名" decoding="async" />
          <div class="product-info">
            <div class="product-info-top">
              <p class="price">$40</p>
              <button class="icon">i</button>
        ...
        <div class="product-card">
          <img src="<?php echo get_template_directory_uri(); ?>/images/section1-6.png" alt="商品名" decoding="async" />
          <div class="product-info">
            <div class="product-info-top">
              <p class="price">$40</p>
              <button class="icon">i</button>
